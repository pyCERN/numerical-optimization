...
public:
    ...
    double findStepSize() const;

private:
    double phi(double stepSize) const;
    double g_phi(double stepSize) const;
    double interpolate(double stepSizeLow, double stepSizeHigh) const;
    double zoom(double stepSizeLow, double stepSizeHigh) const;
